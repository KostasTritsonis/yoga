...
const TeamCard = ({element, image, text}) => {
  ...
  return (
    ...
    >
      ...
      <div className={"flex flex-col justify-center 2xl:w-[800px] xl:[700px] md:w-[700px] sm:w-[500px] w-[350px] 2xl:h-[740px] md:h-[700px] sm:h-[550px]  bg-background rounded-3xl"}>
