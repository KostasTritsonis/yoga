        ...
        <div className="container mx-auto mt-10 px-4">
            ...
            <div className="flex flex-wrap justify-center gap-10 pt-10">
                {[
                    ...
                    { icon: card6,button:'Yoga Sessions' ,title: "5 Day Challenge Trainer Series",day:'12 February 2025',id:"5-day-challenge" },
                ].map((item, index) => (
                    <Link key={index} to={item.id}>
                    <div  className=" group cursor-pointer  w-full sm:w-[300px] md:w-[350px]  h-auto md:h-[450px] p-4 bg-white text-primary hover:bg-footer hover:border border-primary  rounded-3xl">
                        ...
                        <div>
                            ...
                            <p className="text-sm sm:pt-24  pt-5">{item.day}</p>
                        </div>
                    </div>
                    </Link>
                ))}
